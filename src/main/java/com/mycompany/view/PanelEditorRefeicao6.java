...
public class PanelEditorRefeicao6 extends AbstractCellEditor implements TableCellEditor {
    ...
    public PanelEditorRefeicao6(JTable tblTabela, RefeicoesView view, User usuario) {
