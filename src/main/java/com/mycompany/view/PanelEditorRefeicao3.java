...
public class PanelEditorRefeicao3 extends AbstractCellEditor implements TableCellEditor {
    ...
    public PanelEditorRefeicao3(JTable tblTabela, RefeicoesView view, User usuario) {
        ...
        btnExcluir.addActionListener(e -> {
            ...
            if (row != -1) {
                ...
                if (confirmar == JOptionPane.YES_OPTION) {
                    ...
                    fireEditingStopped();
                    boolean deletado = dao.deletarAlimentoRefeicao3(id);
