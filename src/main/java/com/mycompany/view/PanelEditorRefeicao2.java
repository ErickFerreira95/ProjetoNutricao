...
public class PanelEditorRefeicao2 extends AbstractCellEditor implements TableCellEditor {
    ...
    public PanelEditorRefeicao2(JTable tblTabela, RefeicoesView view, User usuario) {
        ...
        btnExcluir.addActionListener(e -> {
            ...
            if (row != -1) {
                ...
                if (confirmar == JOptionPane.YES_OPTION) {
                    ...
                    fireEditingStopped();
                    boolean deletado = dao.deletarAlimentoRefeicao2(id);
